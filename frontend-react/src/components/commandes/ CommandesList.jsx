...
const CommandesList = () => {
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                {isClient() && (
                    <button
                        ...
                        className="bg-emerald-500 text-white px-4 py-2 rounded-lg font-semibold hover:bg-emerald-600 transition flex items-center shadow-md hover:shadow-lg"
                    >
            ...
            {error && (
                <div className="bg-rose-50 border-l-4 border-rose-500 p-4 rounded-r flex items-center">
                    <AlertCircle className="text-rose-500 mr-3" size={20} />
                    ...
                    {commandes.length === 0 ? (
                        <div className="text-center py-20">
                            ...
                            {isClient() && (
                                <button
                                    onClick={() => setShowForm(true)}
                                    className="bg-teal-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-teal-700 transition mt-4 inline-flex items-center shadow-md hover:shadow-lg"
                                >
                                    <Plus size={20} className="mr-2" />
