    ...
    return (
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 hover:shadow-md transition">
            <div className="flex justify-between items-center mb-4">
                ...
                <span className={`px-2 py-1 rounded text-sm font-semibold ${
                    commande.statut === 'EN_COURS' ? 'bg-yellow-100 text-yellow-800' :
                        commande.statut === 'TERMINEE' ? 'bg-emerald-100 text-emerald-800' :
            ...
            <div className="flex items-center mb-2">
                <ShoppingBag className="text-teal-600 mr-2" size={20} />
            ...
            <div className="mb-2">
                ...
                <span className="ml-1 font-bold text-teal-600">{commande.montantTotal.toFixed(2)} MAD</span>
            </div>
