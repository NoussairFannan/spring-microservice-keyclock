                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                            {produits.map(produit => (
                                <button
                                    ...
                                    className="p-4 border-2 border-gray-200 rounded-lg hover:border-teal-500 hover:bg-teal-50 transition text-left group"
                                >
                                    <h5 className="font-semibold text-gray-800 mb-1 group-hover:text-teal-600">
                                        {produit.nom}
                                    </h5>
